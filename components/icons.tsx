...
export const Logo = () => (
  <svg width="22" height="22" viewBox="0 0 22 22" fill="none" aria-hidden>
    <path d="M11 1.5l8.2 4.75v9.5L11 20.5 2.8 15.75v-9.5z" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round"/>
    <path d="M11 7.2l4.3 2.48v4.96L11 17.12l-4.3-2.48V9.68z" fill="currentColor" opacity=".9"/>
  </svg>
);
