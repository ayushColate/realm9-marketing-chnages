...
export const PLANS: Plan[] = [
  {
    ...
    features: ["Environment requests, bookings and approvals", "Terraform runs with Git integration", "Remote state with locking", "Drift detection", "Secrets vault integration", "R9 assistant with your own model key", "Community support"],
  },
  {
    ...
    features: ["Everything in Free", "Multiple AWS and Azure connections", "Webhook integrations", "10 workspaces per project", "R9 assistant with your own model key", "Email support"],
  },
  {
    ...
    features: ["Everything in Starter", "SAML single sign-on and SCIM provisioning", "MFA, session security and device fingerprinting", "Proxmox and VMware vCenter", "Custom scanner images and starter projects", "AI usage included", "Priority support"],
  },
  {
    ...
    features: ["Everything in Enterprise", "FinOps: cost explorer, dashboards and anomaly detection", "Rightsizing and usage analysis", "Full audit logs with unlimited retention", "AI usage included", "24/7 support"],
  },
];
...
export const COMPARE: [string, string, string, string, string][] = [
  ...
  ["R9 assistant", "Your own key", "Your own key", "Included", "Included"],
...
export const FAQ: [string, string][] = [
  ...
  ["What does 'your own key' mean for R9?", "On Free and Starter, R9 uses an API key you provide for OpenAI, Azure OpenAI, Anthropic or a custom endpoint, so model usage is billed by your provider. On Enterprise and Ultimate, AI usage is included."],
